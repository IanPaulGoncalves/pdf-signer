...
import { FileText, Trash2, CheckCircle, AlertTriangle, Clock, AlertCircle, Loader2 } from 'lucide-react';
...
const statusConfig: Record<DocumentStatus, { 
  ...
  'auto-found': { label: 'Auto encontrado', icon: CheckCircle, className: 'status-found' },
